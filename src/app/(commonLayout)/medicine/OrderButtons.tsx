...
export default function OrderButtons({ medicineId,
    name,
    price,
    image,
    sellerId,
    ...
    const handleAddToCart = () => {
        ...
        addItem({ id: medicineId, name, price, image, qty: quantity, phoneNumber: phone, shippingAddress: address });
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-11 pr-4 py-3.5 bg-white border border-slate-200 rounded-2xl text-sm focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all placeholder:text-slate-300"
                        />
                    </div>
                </div>
